...
import dk.dma.baleen.s100.xmlbindings.s100.gml.base._5_0.AbstractFeatureType;
import dk.dma.baleen.s100.xmlbindings.s100.gml.base._5_0.S100SpatialAttributeType;
import dk.dma.baleen.s100.xmlbindings.s100.gml.base._5_0.S100TruncatedDate;
...
import dk.dma.baleen.s100.xmlbindings.s100.gml.base._5_0.impl.S100TruncatedDateImpl;
...
public class S124Utils {
     ...
     *             for errors in the unmarshalling operation
     */
    public static List<? extends AbstractGMLType> getDatasetMembers(String s124) throws JAXBException {
...
//            switch (member) {
//            case NAVWARNAreaAffected spatialUncertainty -> members.getNavwarnPartsAndNavwarnAreaAffectedsAndTextPlacements().add(member);
//            case NAVWARNPart atoNFixingMethod -> members.getNavwarnPartsAndNavwarnAreaAffectedsAndTextPlacements().add(member);
//            case TextPlacement positioningInformation -> members.getNavwarnPartsAndNavwarnAreaAffectedsAndTextPlacements().add(member);
//            case null, default -> members.getNavwarnPartsAndNavwarnAreaAffectedsAndTextPlacements().add(member);
//            }
        }
     ...
     */
    public static List<?> generateS124AidsToNavigationTypeGeometriesList(Class<?> aidsToNavigationTypeClass, List<S100SpatialAttributeType> values) {
        // Sanity Checks
    ...
    public static List<S100SpatialAttributeType> getS124AidsToNavigationTypeGeometriesList(AbstractFeatureType aidsToNavigationType) {
        // Sanity Check
     ...
     */
    public static <T extends AbstractFeatureType, R> R handlePerS124AidsToNavigationType(AbstractFeatureType aidsToNavigationType, Class<T> clazz,
     ...
     */
    public static Field getS124AidsToNavigationField(String field, AbstractFeatureType aidsToNavigationType) {
     ...
     * @return The detected geometries field
     */
    public static Class getS124AidsToNavigationDeclaredClass(String className, Class<?> aidsToNavigationTypeClass) {
