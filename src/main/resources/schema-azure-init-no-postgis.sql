-- Database initialization script for Azure PostgreSQL without PostGIS
...
CREATE TABLE IF NOT EXISTS secom_transactional_upload_entity (
    ...
    data_reference VARCHAR(255),
    gml_data TEXT,
    boundaries bytea,  -- Store geometry as binary
